...
export default function RealnameReport() {
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      <main className="max-w-2xl mx-auto bg-white p-6 rounded shadow">
        <h1 className="text-2xl font-bold text-center">實名通報</h1>
        ...
        <form>
          ...
          {/* 電子郵件 */}
          <div className="mb-4">
            <label className="block font-medium mb-1">電子郵件＊</label>
            <input
              type="email"
              defaultValue="example@bjjh.tp.edu.tw"
              className="w-full p-2 border rounded"
              required
            />
          </div>
          ...
          {/* 案件主旨 */}
          <div className="mb-4">
            <label className="block font-medium mb-1">案件主旨＊</label>
            <input
              type="text"
          ...
          <div className="mb-4">
            ...
            <input
              type="url"
              placeholder="Google 雲端硬碟連結 （請共享權限）"
              className="w-full p-2 border rounded"
            />
          </div>
